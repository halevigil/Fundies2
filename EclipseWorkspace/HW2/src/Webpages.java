...
class ExamplesWebpages {
  ...
  boolean testIContentTotalMegabytes(Tester t) {
    return t.checkExpect(text.totalMegabytes(), 0) & t.checkExpect(picture.totalMegabytes(), 12.4)
  ...
  boolean testIContentPictureInfo(Tester t) {
    return t.checkExpect(text.pictureInfo(), "")
        ...
        & t.checkExpect(linkToAssignment.totalMegabytes(), "Submission (submission screenshot)");
  }
