...
class Hyperlink implements IContent {
  ...
  public double totalMegabytesHelp(ILoContent otherContent) {
    return this.destination.totalMegabytesHelp(otherContent);
  }
...
class Webpage {
  ...
  public double totalMegabytesHelp(ILoContent otherContent) {
    return this.content.totalMegabytesHelp(otherContent);
  }
...
class ExamplesWebpages {
  ...
  Webpage article1 = new Webpage("Ben Lerner Creates 100th Programming Language",
