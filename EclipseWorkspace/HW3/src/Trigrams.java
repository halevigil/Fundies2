...
class ConsLoString implements ILoString {
  ...
  // creates a new list of strings with the given first string and rest of list
...
//represents a three word phrase
class Trigram {
  String first;
  String second;
  String third;
...
class ExamplesTrigrams {
  ...
  boolean testTrigramsSecond(Tester t) {
    return t.checkExpect(
        new ConsLoString("1", new ConsLoString("2", emptyS)).trigramsSecond("game"),
        new Trigram("game", "1", "2"))
        && t.checkExpect(new ConsLoString("1", new ConsLoString("2", new ConsLoString("3", emptyS)))
  ...
  // tests the trigramsThird method on the ILoString class
  ...
  // tests the isFullTrigram method on the Trigram class
  ...
  // tests the prependFull method on the ILoTrigram class
  boolean testPrependFull(Tester t) {
    return t.checkExpect(cool.prependFull(e), cool)
        ...
        && t.checkExpect(emptyT.prependFull(e), emptyT)
        && t.checkExpect(emptyT.prependFull(f), new ConsLoTrigram(f, emptyT));
  }
