...
//      return rest.mostCommonTrigramAcc(new ConsLoTrigram(this.first, new MtLoTrigram()),
//          firstCount);
//    }
...
//    }
//    else {
//      return rest.mostCommonTrigramAcc(new ConsLoTrigram(this.first, mostCommonSoFar),
//          highestCount);
//    }
//  }
//
...
//  ILoTrigram usZooList = new ConsLoTrigram(trigramZoo, usList);
//
...
//        && t.checkExpect(usZooList.getFirstCompareTo(), trigramUS)
//        && t.checkExpect(mediumList.getFirstCompareTo(), trigramUAE);
//  }
//
//  // tests the getFirstCompareToAcc method on the ILoTrigram interface
//  boolean testGetFirstCompareToAcc(Tester t) {
//    return t.checkExpect(empty.getFirstCompareToAcc(trigramUS), trigramUS)
//        && t.checkExpect(usList.getFirstCompareToAcc(trigramUAE), trigramUAE)
//        && t.checkExpect(usList.getFirstCompareToAcc(trigramZoo), trigramUS)
//        && t.checkExpect(usList.getFirstCompareToAcc(trigramUs), trigramUS);
//  }
//
